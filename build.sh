...
javac -source 21 -target 21 -d build/shared @build/shared-sources.txt
javac -source 21 -target 21 -cp build/shared -d build/server @build/server-sources.txt
javac -source 21 -target 21 -cp build/shared -d build/client @build/client-sources.txt
